...
static PyObject *__pyx_pw_7dragons_5munge_13tophat_filter_1tophat_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("tophat_filter (wrapper)", 0);
  {
    ...
    __pyx_v_grid = __Pyx_PyObject_to_MemoryviewSlice_dsdsds___pyx_t_double_complex(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_grid.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_NeObjC(__pyx_t_2, __pyx_int_3, 3, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
      ...
      __pyx_v_k_j = (*((double *) ( /* dim=0 */ (__pyx_v_k.data + __pyx_t_17 * __pyx_v_k.strides[0]) )));
 ...
 */
        ...
        __pyx_v_k_k = (*((double *) ( /* dim=0 */ (__pyx_v_k_r.data + __pyx_t_21 * __pyx_v_k_r.strides[0]) )));
 ...
 */
          __pyx_t_22 = sin(__pyx_v_kR);
          __pyx_t_23 = pow(__pyx_v_kR, 3.0);
          if (unlikely(__pyx_t_23 == 0)) {
            PyErr_SetString(PyExc_ZeroDivisionError, "float division");
            __PYX_ERR(0, 54, __pyx_L1_error)
          }
          __pyx_t_24 = cos(__pyx_v_kR);
          __pyx_t_25 = pow(__pyx_v_kR, 2.0);
          if (unlikely(__pyx_t_25 == 0)) {
            PyErr_SetString(PyExc_ZeroDivisionError, "float division");
            __PYX_ERR(0, 54, __pyx_L1_error)
          }
          __pyx_v_val = (3.0 * ((__pyx_t_22 / __pyx_t_23) - (__pyx_t_24 / __pyx_t_25)));
 ...
 */
          ...
          __Pyx_SET_CREAL((*((__pyx_t_double_complex *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_29 * __pyx_v_grid.strides[0]) ) + __pyx_t_30 * __pyx_v_grid.strides[1]) ) + __pyx_t_31 * __pyx_v_grid.strides[2]) ))), (__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_26 * __pyx_v_grid.strides[0]) ) + __pyx_t_27 * __pyx_v_grid.strides[1]) ) + __pyx_t_28 * __pyx_v_grid.strides[2]) )))) * __pyx_v_val));
 ...
 */
          ...
          __pyx_t_37 = __pyx_v_kk;
          __Pyx_SET_CIMAG((*((__pyx_t_double_complex *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_35 * __pyx_v_grid.strides[0]) ) + __pyx_t_36 * __pyx_v_grid.strides[1]) ) + __pyx_t_37 * __pyx_v_grid.strides[2]) ))), (__Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grid.data + __pyx_t_32 * __pyx_v_grid.strides[0]) ) + __pyx_t_33 * __pyx_v_grid.strides[1]) ) + __pyx_t_34 * __pyx_v_grid.strides[2]) )))) * __pyx_v_val));
 ...
 * 
 */
  __pyx_tuple__27 = PyTuple_Pack(16, __pyx_n_s_grid, __pyx_n_s_side_length, __pyx_n_s_radius, __pyx_n_s_dim, __pyx_n_s_k, __pyx_n_s_k_r, __pyx_n_s_n_k, __pyx_n_s_n_k_r, __pyx_n_s_k_i, __pyx_n_s_k_j, __pyx_n_s_k_k, __pyx_n_s_kR, __pyx_n_s_val, __pyx_n_s_ii, __pyx_n_s_jj, __pyx_n_s_kk); if (unlikely(!__pyx_tuple__27)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__27);
  __Pyx_GIVEREF(__pyx_tuple__27);
  __pyx_codeobj__28 = (PyObject*)__Pyx_PyCode_New(3, 0, 16, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__27, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_tophat_filter_pyx, __pyx_n_s_tophat_filter, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__28)) __PYX_ERR(0, 8, __pyx_L1_error)
